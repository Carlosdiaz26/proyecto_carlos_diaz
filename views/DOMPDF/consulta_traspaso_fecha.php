 ...
 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                     <?php 
                        ...
                        $fecha = date('Y/m/d');
                         $sql = ("SELECT * FROM traspaso INNER JOIN inventario ON traspaso.ubicacion_final = inventario.id_oficina INNER JOIN oficina ON traspaso.ubicacion_final = oficina.id_oficina WHERE traspaso.fecha_traspaso >= '$fecha1' AND traspaso.fecha_traspaso <= '$fecha2'");
