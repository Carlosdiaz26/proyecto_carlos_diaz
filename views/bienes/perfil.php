            ...
            <center><h3>Actualizar Perfil</h3></center>
              <div class="card mb-4 py-3 border-bottom-danger">
                <div class="card-body">
                  ...
                  <form method="POST" action="../../controllers/actualizar/actualizar_perfil2.php">
                    <label><b>Nombre Completo</b></label>
                    <input type="hidden" name="id_registro" value="<?php echo $id; ?>">
                    <input type="text" name="nombre" value="<?php echo $reg['nombre']; ?>" class="form-control">
                    <label><b>Cedula</b></label>
                    <input type="text" name="cedula" value="<?php echo $reg['cedula']; ?>" class="form-control" required>
