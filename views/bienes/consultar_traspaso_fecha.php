...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
      ...
      <p align="right"><a href="../DOMPDF/consulta_traspaso_fecha.php?fecha1=<?php echo $fecha1; ?>&fecha2=<?php echo $fecha2; ?>" class="btn btn-secondary" target="nuevo"><i class="fas fa-file-download"></i> Generar Reporte PDF</a></p>
                                      ...
                                      <tbody>
                                        <?php 
                                              ...
                                              $sql = ("SELECT * FROM traspaso 
                                                           INNER JOIN inventario ON traspaso.ubicacion_final = inventario.id_oficina
                                                           INNER JOIN oficina ON traspaso.ubicacion_final = oficina.id_oficina WHERE traspaso.fecha_traspaso >= '$fecha1' AND traspaso.fecha_traspaso <= '$fecha2'");
