<div class="table-responsive">
  <p align="right"><a href="../DOMPDF/consulta_e_en_cola.php" class="btn btn-secondary" target="nuevo"><i class="fas fa-file-download"></i> Descargar</a></p>
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
                       ...
                       require_once("../../models/consulta/consulta_e_en_cola.php");
                       foreach ($result as $equipo) {
                    ?>
                    <b>Total de Registros:</b>&nbsp;<span class="badge badge-success"><?php echo $c; ?></span>
                    <tr>
