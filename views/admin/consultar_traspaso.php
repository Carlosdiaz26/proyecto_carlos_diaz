                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><a href="../DOMPDF/traspaso_id.php?id=<?php echo $traspaso['id_traspaso']; ?>" class="btn btn-primary"><?php echo $traspaso['id_traspaso']; ?><i class="fas fa-file-download"></i></a></td>
                                        </tr>
                                        <?php 
                                           } 
                                        ?>                   
