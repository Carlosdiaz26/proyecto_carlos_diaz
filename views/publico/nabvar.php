...
<?php include("../../models/id/ente.php"); ?>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <title>Yo me Quedo en Caasa - Informatica Alcaldia Bolivariana del Municipio Juan German Roscio</title>
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>Equipos en Reparación</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Equipos en Reparación</h6>
            <a class="collapse-item" href="seguimiento.php">Seguimiento</a>
          </div>
        </div>
      </li>
